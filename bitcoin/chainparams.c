...
const struct chainparams networks[] = {
    ...
    {.network_name = "vertcoin",
     ...
     .lightning_hrp = "vtc",
     .bip70_name = "main",
     .genesis_blockhash = {{{.u.u8 = {0xc4, 0xf0, 0x89, 0x04, 0x11, 0x22, 0x2d, 0x49,
     ...
     .cli = "vertcoin-cli",
     .cli_args = NULL,
     .cli_min_supported_version = 170000,
     .dust_limit = { 100000 },
     /* BOLT #2:
      *
      * The sending node:
     ...
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_MAIN_PUBLIC,
			   .bip32_privkey_version = BIP32_VER_MAIN_PRIVATE},
     .is_elements = false},
    {.network_name = "vertcoin-regtest",
     .onchain_hrp = "vtcrt",
     .lightning_hrp = "vtcrt",
     .bip70_name = "regtest",
     .genesis_blockhash = {{{.u.u8 = {0xce, 0x85, 0x4a, 0xdc, 0x33, 0xe8, 0x7c, 0xc1,
     ...
     .bip32_key_version = {.bip32_pubkey_version = BIP32_VER_TEST_PUBLIC,
			   .bip32_privkey_version = BIP32_VER_TEST_PRIVATE},
     .is_elements = false},
// Signet - make new genesis hash
//    {.network_name = "vertcoin-signet",
//     .onchain_hrp = "tvtcs",
//     .lightning_hrp = "tvtcs",
//     .bip70_name = "signet",
//     // 00000008819873e925422c1ff0f99f7cc9bbb232af63a077a480a3633bee1ef6
...
//     .is_elements = false,
//    },
    {.network_name = "vertcoin-testnet",
     .onchain_hrp = "tvtc",
     .lightning_hrp = "tvtc",
     .bip70_name = "test",
     .genesis_blockhash = {{{.u.u8 = {0xc9, 0xd2, 0x7a, 0x49, 0x47, 0x27, 0x2e, 0xe3,
